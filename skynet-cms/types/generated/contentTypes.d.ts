...
export interface ApiFaqFaq extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<
      ['General', 'Shipping', 'Tracking', 'Pricing', 'Support']
    >;
...
export interface ApiLegalPageLegalPage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    lastUpdated: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'Last updated: January 2025'>;
    pageType: Attribute.Enumeration<
      ['privacy_policy', 'terms&Condition', 'refund_policy']
    >;
    sections: Attribute.DynamicZone<['legal.text-section']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiOfficeLocationOfficeLocation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    isHeadOffice: Attribute.Boolean;
    addresses: Attribute.Component<'address.addresses', true>;
    coordinates: Attribute.Component<'coordinates.coordinates', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ctaText: Attribute.String & Attribute.DefaultTo<'Learn More'>;
    ctaLink: Attribute.String;
    Highlights: Attribute.Component<'service.service-highlight', true> &
      Attribute.Required &
      Attribute.SetMinMax<
        {
          min: 3;
        ...
        number
      >;
    related_services: Attribute.Relation<
      'api::service.service',
      'manyToMany',
      'api::service.service'
    >;
...
export interface ApiShippingRateShippingRate extends Schema.CollectionType {
  ...
  attributes: {
    from_country: Attribute.String &
      Attribute.Required &
      Attribute.SetMinMaxLength<{
        maxLength: 50;
      }> &
      Attribute.DefaultTo<'India'>;
    destination_country: Attribute.String &
      Attribute.Required &
      Attribute.SetMinMaxLength<{
        maxLength: 50;
      }>;
    weight_from: Attribute.Decimal &
      Attribute.Required &
      Attribute.DefaultTo<0>;
    weight_to: Attribute.Decimal & Attribute.Required & Attribute.DefaultTo<0>;
    rate_inr: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<0>;
    serviceDays: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
